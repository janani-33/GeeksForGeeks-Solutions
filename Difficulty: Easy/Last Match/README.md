<h2><a href="https://www.geeksforgeeks.org/problems/last-match1928/1?page=1&status=attempted&sprint=90411debc5fbd1ca03159ed2b7fe4481&sortBy=submissions">Last Match</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings A and B, you need to find the last&nbsp;occurrence ( 1 based indexing) of string B in string A.</span></p>
